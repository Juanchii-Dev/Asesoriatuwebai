        ...
        <div className="grid md:grid-cols-4 gap-8 mb-10">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-[#00CCFF] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/corporativos" className="hover:text-[#00CCFF] transition-colors">Sitios corporativos</a></li>
              <li><a href="/#services" className="hover:text-[#00CCFF] transition-colors">Landing pages</a></li>
              <li><a href="/ecommerce" className="hover:text-[#00CCFF] transition-colors">E-commerce</a></li>
              <li><a href="/uxui" className="hover:text-[#00CCFF] transition-colors">Experiencia UX/UI</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/#philosophy" className="hover:text-[#9933FF] transition-colors">Nuestra filosofía</a></li>
              <li><a href="/#process" className="hover:text-[#9933FF] transition-colors">Proceso de trabajo</a></li>
              <li><a href="/#tech" className="hover:text-[#9933FF] transition-colors">Tecnologías</a></li>
              <li><a href="/#impact" className="hover:text-[#9933FF] transition-colors">Casos de éxito</a></li>
            ...
            <div className="space-y-2">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="mailto:hola@tuweb.ai" className="hover:text-[#00CCFF] transition-colors">hola@tuweb.ai</a>
                </div>
              </div>
