...
export default function HeroSection({ setRef }: HeroSectionProps) {
  ...
  return (
    ...
    >
      <motion.div style={{ y: y1, position: 'absolute', top: '-150px', right: '-150px' }}>
        <AnimatedShape type={1} className="" />
      </motion.div>
      
      <motion.div style={{ y: y2, position: 'absolute', bottom: '-100px', left: '-100px' }}>
        <AnimatedShape type={2} className="" delay={3} />
      </motion.div>
