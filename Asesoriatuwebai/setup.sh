...
# Force the server to listen on port 5000 and host 0.0.0.0
# Create or modify the vite.config.js file
...
# Copy Websy image to public/images directory
cp ../websy-image.jpg public/images/websy.jpg

# Modify the chatbot component to include Websy image and welcome message
